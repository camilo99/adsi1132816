...
abstract class DataBase {
	...
	class Model extends DataBase{
		...
		public function addUsersPco($documento,$nombres,$telefono,$direccion,$ciudad,$correo){
			 $this->conx->query("INSERT INTO usuarios(documento,nombres,telefono,direccion,ciudad,correo,clave,rol) VALUES('$documento','$nombres','$telefono','$direccion','$ciudad','$correo','cliente','cliente')");
